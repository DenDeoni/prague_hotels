...
class PropertySearchModel {
  ...
  factory PropertySearchModel.fromJson(Map<String,dynamic> json) => PropertySearchModel(
    propertySearch: json['propertySearch'] != null ? (json['propertySearch'] as List? ?? []).map((e) => PropertyListModel.fromJson(e as Map<String, dynamic>)).toList() : null
  );
  ...
  PropertySearchModel copyWith({
    Optional<List<PropertyListModel>?>? propertySearch
  }) => PropertySearchModel(
    propertySearch: checkOptional(propertySearch, () => this.propertySearch),
  );
